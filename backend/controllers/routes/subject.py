...
subject_router = APIRouter(tags=[Tags.SUBJECT])


@subject_router.get("/subjects/{subject_id}", summary="Get a certain subject.")
...
@subject_router.get("/subjects/{subject_id}/projects", summary="Get all projects of subject.")
...
@subject_router.get("/subjects/{subject_id}/teachers", summary="Get all teachers of subject.")
...
@subject_router.get("/subjects/{subject_id}/students", summary="Get all students of subject.")
...
@subject_router.post("/subjects/{subject_id}/projects", summary="Create project in a course.")
...
@subject_router.put("/subjects/{subject_id}", summary="Update a subject")
